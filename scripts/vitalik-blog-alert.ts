...
▎세 줄 요약 (핵심을 정확히 세 줄로, 한 줄에 하나씩, 각 줄 앞에 "• "를 붙입니다.
  각 줄은 "~하는 방식", "~를 제안", "~이 목표" 처럼 명사형으로 짧게 끝냅니다.
  "~습니다" 같은 서술형 종결은 쓰지 않고, 문단으로 이어 쓰지 않습니다.)
...
문체: 세 줄 요약만 명사형 종결, 본문 요약 & 설명과 왜 중요한가는 "~습니다"체로 씁니다.
