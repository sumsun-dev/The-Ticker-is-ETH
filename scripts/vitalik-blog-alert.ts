...
▎본문 해설 (전체 분량의 8할 이상. 글의 전개 순서를 그대로 따라가며, 각 부분이 무슨
  이야기를 하는지 차근차근 설명합니다. 글 안의 소제목 흐름대로 문단을 나누고, 새 개념이
  등장하면 그 자리에서 한두 문장으로 풀어 설명한 뒤 진행합니다. 글에 나온 예시·수치·비유는
  적극 활용해 재서술합니다. "왜 이 문제가 어려운지", "이 방식이 기존과 무엇이 다른지"를
  독자가 따라올 수 있게 짚어주세요.)
