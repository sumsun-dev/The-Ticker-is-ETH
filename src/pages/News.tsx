            ...
            {!isLoading && currentDigest && (
                <article>
                    ...
                    {currentDigest.sections.length > 1 && (
                        <nav className="flex flex-wrap gap-2 mb-10" aria-label={t('sectionNav')}>
                                ...
                                <button
                                    ...
                                    className={`group text-left rounded-2xl overflow-hidden border transition-all ${
                                        isCurrent
                                            ...
                                            : 'border-theme-border hover:border-brand-primary/50 hover:-translate-y-1'
                                    }`}
                                >
                                    {digest.coverImage ? (
                                        <img
                                    ...
                                    <div className="p-4 bg-theme-surface">
                                        ...
                                        <p className="text-sm font-semibold leading-snug line-clamp-2 group-hover:text-brand-accent transition-colors">
                                            {digest.title}
                                        </p>
                                    </div>
                                </button>
